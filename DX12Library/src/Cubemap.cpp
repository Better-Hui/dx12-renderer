...
const std::shared_ptr<Texture>& Cubemap::GetTexture() const
{
    return m_RenderedCubemap.GetTexture(Color0);
}

const std::shared_ptr<Texture>& Cubemap::GetFallbackTexture() const
{
    return m_FallbackCubemap;
}

D3D12_SHADER_RESOURCE_VIEW_DESC Cubemap::GetSrvDesc() const
{
    return m_SrvDesc;
}
