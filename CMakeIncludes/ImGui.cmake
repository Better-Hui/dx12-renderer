...
set(DX12_RENDERER_IMGUI_GENERATED_SOURCE_DIRECTORY "${CMAKE_BINARY_DIR}/Generated/ImGui")
set(DX12_RENDERER_IMGUI_PATCHED_WIDGETS_SOURCE "${DX12_RENDERER_IMGUI_GENERATED_SOURCE_DIRECTORY}/imgui_widgets.cpp")
file(MAKE_DIRECTORY "${DX12_RENDERER_IMGUI_GENERATED_SOURCE_DIRECTORY}")

# Keep implementation units in a stable generated directory so Visual Studio
# does not expose FetchContent's internal download directory in Framework.
set(DX12_RENDERER_IMGUI_COMPILED_SOURCES)
foreach(DX12_RENDERER_IMGUI_SOURCE_FILE
        imgui.cpp
        imgui_draw.cpp
        imgui_tables.cpp
        backends/imgui_impl_dx12.cpp
        backends/imgui_impl_win32.cpp)
        get_filename_component(DX12_RENDERER_IMGUI_SOURCE_NAME "${DX12_RENDERER_IMGUI_SOURCE_FILE}" NAME)
        set(DX12_RENDERER_IMGUI_GENERATED_SOURCE_FILE "${DX12_RENDERER_IMGUI_GENERATED_SOURCE_DIRECTORY}/${DX12_RENDERER_IMGUI_SOURCE_NAME}")
        configure_file(
                "${DX12_RENDERER_IMGUI_SOURCE_DIRECTORY}/${DX12_RENDERER_IMGUI_SOURCE_FILE}"
                "${DX12_RENDERER_IMGUI_GENERATED_SOURCE_FILE}"
                COPYONLY)
        list(APPEND DX12_RENDERER_IMGUI_COMPILED_SOURCES "${DX12_RENDERER_IMGUI_GENERATED_SOURCE_FILE}")
endforeach()
...
list(APPEND DX12_RENDERER_IMGUI_COMPILED_SOURCES "${DX12_RENDERER_IMGUI_PATCHED_WIDGETS_SOURCE}")
# Modify End
