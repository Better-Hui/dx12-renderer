...
#define RAYTRACING_DEMO_BLUE_NOISE_SCALAR_REGISTER register(t28, COMMON_ROOT_SIGNATURE_PIPELINE_SPACE)
#define RAYTRACING_DEMO_BLUE_NOISE_VEC2_REGISTER register(t29, COMMON_ROOT_SIGNATURE_PIPELINE_SPACE)
...
#define RAYTRACING_DEMO_BLUE_NOISE_SCALAR_REGISTER register(t12, space0)
#define RAYTRACING_DEMO_BLUE_NOISE_VEC2_REGISTER register(t13, space0)
...
Texture2D<float> FrameworkBlueNoiseScalarTexture : RAYTRACING_DEMO_BLUE_NOISE_SCALAR_REGISTER;
Texture2D<float4> FrameworkBlueNoiseVec2Texture : RAYTRACING_DEMO_BLUE_NOISE_VEC2_REGISTER;
