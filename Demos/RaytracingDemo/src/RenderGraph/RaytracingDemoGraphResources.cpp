...
//Modify Begin:2026-09-13 by Hui
            { ResourceIds::GBufferEmissionMetallic, renderWidthExpression, renderHeightExpression, GBUFFER_EMISSION_FORMAT, GBUFFER_CLEAR_COLOR, RenderGraph::ResourceInitAction::Clear },
//Modify End
...
//Modify Begin:2026-09-10 by Hui
        std::vector<RenderGraph::TokenDescription> tokenDescriptions = {
            ...
            { ResourceIds::MeshletCandidateExpandFinishedToken },
            { ResourceIds::MeshletFineCullFinishedToken },
            { ResourceIds::MeshletStatisticsReadbackFinishedToken },
